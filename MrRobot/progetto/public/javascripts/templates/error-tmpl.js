...
function emailError(){
    return `<div class="indexError" id="emailError">La tua Email non ha il formato corretto</div>`;
}

function passwordError(){
    return `<div class="indexError" id="passwordError">La password deve avere ALMENO 6 caratteri, 1 maiuscola E 1 cifra </div>`;
}

export {nullError, indexNullResponse, userRequestAlreadyInDB, errorInDB, loginError, adminLoginError, notLogged,emailError,passwordError}; 